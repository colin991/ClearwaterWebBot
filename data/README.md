...
- `site-updates.json` — tracked catalog of bot updates to announce in Discord (committed to git)
- `site-updates-posted.json` — host-local record of which update ids were already posted (gitignored)
