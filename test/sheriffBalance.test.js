...
test('resolveSheriffDiscordId prefers linked Roblox ID and skips ambiguous names', () => {
  const members = new Map([
    ['111111111111111111', { id: '111111111111111111', nickname: 'Deputy | Player28', user: {} }],
    ['222222222222222222', { id: '222222222222222222', nickname: 'Also Player28', user: {} }],
    ['333333333333333333', { id: '333333333333333333', nickname: 'Deputy | UniqueName', user: {} }],
  ]);
  assert.equal(resolveSheriffDiscordId({ username: 'Player28', robloxId: '24' }, members, {
    '111111111111111111': { robloxId: '24' },
  }), '111111111111111111');
  assert.equal(resolveSheriffDiscordId({ username: 'Player28', robloxId: '24' }, members), null);
