...
- A player with no matching Discord member is PMed a jail notice and jailed immediately (they stay on the server). A partial Discord cache is never treated as “not in Discord.”
