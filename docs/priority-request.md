...
- After that in-game hint, the bot joins voice channel `1514128904783139018`, plays `assets/priority-beep.mp3`, then speaks with Edge **Brian** at speed **1.15**: who started it, the vehicle description, and the priority type.
